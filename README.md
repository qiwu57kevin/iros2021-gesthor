...
You can download our dataset from [here](https://drive.google.com/drive/folders/1RBQNpqQ2EEXQ4mipaUcbkuSVPnhiJEc-?usp=sharing). Unpack this package under `datasets` folder. The `ithor-objectnav-gesture` folder after unpacking contains:
